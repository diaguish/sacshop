    ...
    <div class="flex flex-1 items-center justify-end md:justify-between">
      <nav aria-label="Global" class="hidden md:block">
        <ul class="flex items-center gap-6 text-sm">
          <li>
            <a class="text-gray-500 transition hover:text-gray-500/75" href="{{ route('home') }}"> Accueil </a>
          </li>

          <li>
            <a class="text-gray-500 transition hover:text-gray-500/75" href="{{ route('shop.index') }}"> Boutique </a>
          </li>

          <li>
            <a class="text-gray-500 transition hover:text-gray-500/75" href="{{ route('cart.index') }}"> Panier </a>
          </li>

          <li>
            <a class="text-gray-500 transition hover:text-gray-500/75" href="#"> profil </a>
          </li>
        </ul>
      </nav>
